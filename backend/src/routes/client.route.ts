...
clientRouter.delete('/delete:clientId', verifyToken, clientController.softDeleteClient);
clientRouter.patch('/restore:clientId/restore', verifyToken, clientController.restoreDeletedClient);
